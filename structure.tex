...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= darkjose,bookmarks=true,bookmarksopen=false,pdftitle={Apuntes de Programación Matemática},pdfauthor={Author}}
\usepackage{bookmark}
\bookmarksetup{
open,
numbered,
